...
function tempSubmit(opt,val){
	...
	tempForm.action =  mozi.contextPath +"/waterInpour/water.do";;
    tempForm.method = "post";
    tempForm.style.display = "none";
    var opt1 = document.createElement("textarea");
    opt1.name = "accountNo";
    opt1.value = $("[name='accountNo']").val();
    ...
    opt6.name = "cmdWater";
    opt6.value = $("[name='cmdWater']").val();
    tempForm.appendChild(opt6);
