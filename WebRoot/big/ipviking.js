...
(function(window) {
    ...
    */
    var settings = {
        ...
        // Websocket settings
        wsHost: "ws://" + websoctBasePath + "/message",//ws://10.121.58.47:8080/TestBI/message
        ...
        stats: [
            ...
            new Stats({
                ...
                redraw: function() {
            		...
            		var data = entries.sort(function(d1, d2) { return d2.value - d1.value; })
            ...
            new Stats({
                ...
                redraw: function() {
                    ...
                    var entries = this.state.entries();
            		var data = entries.sort(function(d1, d2) {
                ...
                redraw: function() {
                    ...
                    var cols = rows.selectAll("td")
                        .data(function(d) {
                            return [
                                d.datetime,
                              //  spanWrap(d.org, ["org", "overflow"]),	   注释销售组织
                                spanWrap(
                                   // (d.city === "" ? "unknown" : d.city) + ", " +	  注释城市
                                        countryModel.getByIso2(d.country).country,
                                    ["location", "overflow"]),
                                d.md5,
                                spanWrap(
                                   // (d.city2 === "" ? "unknown" : d.city2) + ", " +  注释城市
...
//            	console.log(d.latitude);
        ...
        webSocket.onmessage = function(evt) {
           ...
           // console.log(evt);
            ...
            if(datum.replay){
            	$("#left-data").find(".numeric").text(0);
            	
            	$("#right-data").find(".numeric").text(0);
    ...
    queue()
        .defer(d3.json, "big/data/readme-world.json")
        .defer(d3.tsv, "big/data/port-names.tsv")
        .defer(d3.csv, "big/data/country-codes.csv")
